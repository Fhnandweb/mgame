...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-12-25 10:42:10
...
(53, 'dwqd', '2018-12-24 14:01:55', 'dwqd', '27');
...
(27, 'ewqe', 'scsacsa', 'fhn', '2018-12-24 14:01:46');
...
CREATE TABLE `info` (
  ...
  `core` varchar(6) DEFAULT NULL,
  `gtype` varchar(20) DEFAULT NULL,
  `gtext` varchar(500) DEFAULT NULL,
...
(1, '\r\n拳皇98：终极对决', '9.4', '格斗游戏', '《拳皇98：终极对决》是一款由SNK于2008年在Arcade和PS2平台上发布的2D格斗游戏，后登陆PC平台。该作其实为《拳皇98》的强化版，游戏承袭原作内容与系统，并强化平衡度、加入新角色与新系统“极限模式”。在“极限模式”下，玩家可以任意在各种动作之间组合自己惯用的角色模式。', './img/info/quanhuang.jpg', '1'),
(9, '魔兽争霸3：冰封王座', '9.6', '即时战略', '　　在《魔兽争霸3：冰封王座》中，暴雪第一次让“英雄”在一个即时战略游戏中起到了如此重要的作用，也让即时战略游戏进入到一个崭新的时期。\r\n　　“英雄”的概念使得这款游戏既注重团队精神又有显示个人魅力的思想，当然，前者是最重要的，任何强大的个人也不能和一支军队相提并论。另一个特点是他需要玩家有高超的操作技巧，强烈的意识，细微的洞察及智慧的头脑！', './img/info/ms.jpg', '2'),
(10, '鬼泣4:特别版', '9.2', '动作冒险', '《鬼泣4：特别版》是一款Capcom制作并发售的动作冒险游戏。相比起《鬼泣4》来说，游戏此次对很多原版内容都进行了大幅度优化。新模式加入“VERGIL GAME”、“LADY/TRISH GAME”，但丁和尼禄的关卡可以使用维吉尔、lady、翠西畅玩，还有全新的日语声优配音。游戏的限定版还会追加lady、翠西的特别服装。另外只有PC版才有“无双模式”，支持1080p，60帧画质。', './img/info/gq.jpg', '3'),
(11, '古墓丽影9', '9.3', '动作冒险', '《古墓丽影》新作将讲述劳拉的首次冒险之旅，主角劳拉·克劳馥的年龄被设定在21岁，那时的她还只是一名刚出茅庐的新人，经验欠缺。随着游戏剧情的发展，玩家将与劳拉共同成长，获得新的武器和道具并习得新技能。在冒险的小岛上，玩家可以在营地对道具进行组合，有些特定区域就需要特定道具和技能才能通过。岛上的各个营地之间可以快捷传送，玩家无需长途跋涉。而除了劳拉外还将有其他角色出现在岛上。此外游戏还有饥饿度的设计，玩家要不停搜寻补充人体生存必须的水和食物。', './img/info/gm.jpg', '4'),
(12, '合金装备2:实体', '8.0', '动作游戏', '《合金装备2：实体》是《合金装备2：自由之子》的加强版，追加了超过700个VR任务关和5个以SNAKE为主角的平行剧本。\r\n　　《合金装备》历来给人的感觉是电影与游戏的结合体。本作中时刻体现着电影的元素，游戏开场那段Snake（斯内克）跳下纽约乔治·华盛顿大桥后站到油轮上的画面明显借鉴了电影《终结者2》，游戏中Snake与俄国士兵Olga（奥尔迦）战斗时的慢镜头又与《黑客帝国》中的子弹如出一辙。', './img/info/hj.jpg', '5'),
(13, '反恐精英', '9.4', '第一人称射击', '《反恐精英》是由Valve开发的第一人称射击游戏系列。游戏最初是Valve旗下游戏《半条命》的其中一个游戏模组，由Minh Le与Jess Cliffe开发。后该模组被Valve收购，两名制作人在则在Valve公司继续工作。目前系列已有五部《半条命：反恐精英》、《反恐精英》、《反恐精英：零点行动》、《反恐精英：起源》和《反恐精英：全球攻势》。玩家被分为“恐怖分子”和“反恐精英”两队，在地图上进行多回合战斗，完成对应的任务或杀死全部敌人。', './img/info/cs.jpg', '6'),
(14, '火影:究极风暴3', '9.3', '格斗游戏', '《火影忍者疾风传：究极忍者风暴遗产》是由Cyber Connect2制作，Namco Bandai发行的一款动作格斗类游戏，本合集收录了《火影忍者：究极忍者风暴》系列三部作品，以及《火影忍者：究极忍者风暴4 博人之路》。故事发生在鸣人和伙伴少年时代的热血物语，剧情分别收录了从动漫中《疾风传》篇章到和“晓”组织的鏖战的故事，玩家还可以体验“忍界大战”的恢宏战役，更有博人的登场，这部作品使整个火影的历史得以完整重现在玩家面前。', './img/info/hy.jpg', '7'),
(15, '实况足球2018', '8.1', '体育游戏', '《实况足球2018》是由Konami制作并发行的一款足球类体育竞技游戏，是著名足球游戏系列《实况足球》的正统续作。相较于前作，本作增加了更多的球员数据，在画质上也得到了提升。\r\n　　游戏在玩法上比前作更加精炼，本作拥有更加流畅的操控感和更加顺畅的战术运用，球员可根据情况使用身体控球去阻挡来自防守的威胁，在运球的时候通过简单的操作虚晃身体，攻破对手的防线。\r\n　　系统方面，游戏的随机选择模式将在添加新的功能之后重新登场。大师联赛也将增加新元素，包括参加季前巡回赛、转会系统、赛前采访和球队更衣室等内容。', './img/info/sk.jpg', '8');
